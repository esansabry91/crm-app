...
// uses (see src/firebase.ts). These values are not secret; Firebase web configs are safe to
// ship in client code by design (they already appear in the CRM's own built JS bundle) — actual
// access control lives entirely in firestore.rules, not in hiding this file's contents.
